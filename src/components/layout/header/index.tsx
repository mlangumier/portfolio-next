...
const Header: React.FC<Props> = ({ navItems }) => {
  ...
  // TODO: Move grids to configs
  // TODO: Translate mobile-nav titles
  // TODO: Find another way to handle background-overflow (z-index overflow? no-scroll? contain? hidden? ask GPT)
  // TODO: Click title must close menu on mobile, but be ignored on desktop
  // TODO: Either manage flags sizes (height, especially) or turn them into SVG components
  ...
  return (
    <header className="fixed z-40 w-full bg-primary-light">
      <div className="container relative flex min-h-20 flex-row items-center justify-between">
        {/* Title */}
        <div className="col grid w-full grid-cols-[auto_1fr_minmax(0,_2.5rem)] items-center gap-3 md:w-fit md:grid-cols-[auto_1fr]">
        ...
        >
          <div className="flex h-full w-full min-w-fit max-w-screen-sm flex-col gap-4 bg-primary-light px-6">
            <div className="mt-4">
              <p className="font-light uppercase text-grey">Pages</p>
            ...
            <div>
              <p className="font-light uppercase text-grey">Switch language</p>
              <ul className="flex h-full flex-col">
                <li className="px-4">
